...
pixi add tblite tblite-devel
# for installing globally
pixi global install tblite tblite-devel
```
...
It is possible to list all of the versions of `tblite` available on your platform:
...
```
pixi search tblite --channel conda-forge
```
